...
INSERT INTO `CartRow` VALUES (9,2,4,1),(10,2,5,1),(11,2,1,1),(12,2,3,1),(13,2,2,1),(39,1,5,2),(40,1,6,1);
...
INSERT INTO `Inventory` VALUES (6,1,'AAA101',87),(7,2,'AAA102',86),(8,3,'AAA101',82),(9,4,'AAA102',81),(10,5,'AAA102',88);
...
CREATE TABLE `Offer` (
  ...
  PRIMARY KEY (`id`),
  KEY `product` (`product`),
  CONSTRAINT `offer_ibfk_1` FOREIGN KEY (`product`) REFERENCES `Product` (`id`)
...
INSERT INTO `Offer` VALUES (1,'Super Blender',1,'hej',5.00,NULL,'2017-07-12 16:03:58'),(2,'Kitchen Collection',5,'hej',5.00,NULL,'2017-07-12 16:02:43'),(3,'Fab Egg Cup',4,'he',5.00,NULL,'2017-07-12 16:05:52'),(4,'Super Egg Cup',2,'YOHOO',50.00,NULL,'2017-07-12 16:06:11'),(5,'Super Cheesus',3,'!!!',30.00,63.00,NULL);
...
INSERT INTO `Order` VALUES (18,1,'2017-07-12 13:37:44',NULL,NULL,NULL),(19,2,'2017-07-12 13:50:20',NULL,NULL,NULL),(20,2,'2017-07-12 13:55:43',NULL,NULL,NULL),(21,2,'2017-07-12 14:00:13',NULL,NULL,NULL),(22,2,'2017-07-12 14:06:02',NULL,NULL,NULL);
...
INSERT INTO `OrderRow` VALUES (34,18,5,2),(35,18,6,1),(36,19,4,1),(37,19,5,1),(38,19,1,1),(39,19,3,1),(40,19,2,1),(41,20,4,1),(42,20,5,1),(43,20,1,1),(44,20,3,1),(45,20,2,1),(46,21,4,1),(47,21,5,1),(48,21,1,1),(49,21,3,1),(50,21,2,1),(51,22,4,1),(52,22,5,1),(53,22,1,1),(54,22,3,1),(55,22,2,1);
...
INSERT INTO `Product` VALUES (1,'Super Blender','Blender',90.00,'blender.jpg',NULL),(2,'Super Egg Cup','Egg Cup 1',90.00,'egg-cup-1.jpg',NULL),(3,'Super Cheesus','Cheese Slicer',90.00,'cheese-slicer.jpg',NULL),(4,'Fab Egg Cup','Egg Cup 2',90.00,'egg-cup-2.jpg',NULL),(5,'Kitchen Collection','Kitchen Utensils',400.00,'utensils-kitchen.jpg',NULL),(6,'Kitchen Collection','Kitchen knives',200.00,'utensils-kitchen.jpg',NULL);
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vproduct` AS select `P`.`id` AS `id`,`P`.`name` AS `name`,`P`.`description` AS `description`,`P`.`image` AS `image`,group_concat(distinct `PC`.`category` separator ',') AS `category`,`P`.`price` AS `price`,`offer`.`new_price` AS `new_price`,`I`.`items` AS `items` from ((((`product` `P` left join `prod2cat` `P2C` on((`P`.`id` = `P2C`.`prod_id`))) left join `prodcategory` `PC` on((`PC`.`id` = `P2C`.`cat_id`))) left join `offer` on((`P`.`id` = `offer`.`product`))) left join `inventory` `I` on((`P`.`id` = `I`.`prod_id`))) group by `P`.`id` order by `P`.`name` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2017-07-12 18:04:20
